...
public class MultipleConstConstList extends ConstList {

    private ConstList ConstList;
    private Const Const;

    public MultipleConstConstList (ConstList ConstList, Const Const) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultipleConstConstList(\n");
